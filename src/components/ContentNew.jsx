      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="px-1 py-4">
          <div className="flex sm:flex-row justify-between items-center">
            <h1 className="font-bold text-gray-900">Ilmari Hämäläinen</h1>
        ...
        <section className="py-16 md:py-15">
          <div className=" mx-auto px-6">
            <div className="text-center">
              ...
              <div className="bg-blue-50 border-blue-500 p-6 rounded-r-lg text-left  mx-auto mb-8">
                <p className="text-gray-700 leading-relaxed">
                  Aspiring data engineer and full-stack web developer with hands-on industry experience at <b>Fingrid Datahub</b>. 
                  Currently completing a Master's Thesis on <b> data analytics platform design for Datahub reporting </b> as a full-time role at Fingrid. 
                  Skilled in <b> big data </b> technologies and modern web development, with a strong interest in building scalable, data-driven systems.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-blue-500 pl-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Working on a Master's Thesis: designing a enterprise-scale data analytics platform for 
          ...
          <div className=" mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                ...
                <div className=" flex items-center flex-wrap gap-2 mt-4 mb-0">
                  <Github size={16} />
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200 md:col-span-2 mb-2">
                ...
                <div className="flex items-center flex-wrap gap-2 mt-2 mb-0">
                  <Github size={16} />
